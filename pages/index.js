  ...
  return (
    <>
      ...
      <main className="bg-primary">
        ...
        <div className="flex w-full h-[10vh] bg-accent">
        </div>
        <div className="p-10 w-full h-full bg-primary text-accent gap-6 flex flex-col justify-center items-center">
          ...
          <div className="flex flex-row gap-10 justify-center items-center">
            <div className="flex flex-col gap-2 w-2/5 h-full">
              ...
              <p><span>Address</span>: 3030 Don Mills Rd., North York, ON M2J 3B6</p>
              <p className="pb-3"><span>Note</span>: Located at the intersection of Van Horne and Don Mills, 6 minutes away from the Mosque.</p>
              <div className="h-[30vh] w-full bg-secondary overflow-hidden rounded-lg">
                <GoogleMapReact
                  bootstrapURLKeys={{
                    key: "AIzaSyC9GXPLoA17WIKHL_hPktNCy6w6Lw8KB44",
                  }}
            ...
            <div>
              ...
              >
                ...
                <input
                  ...
                  className="placeholder-accent ph placeholder-opacity-50 bg-secondary input w-full"
                />
                <button className="btn bg-accent border-none text-primary text-base" type="submit">
                  Submit Booking
                </button>
              </form>
            </div>
